  ...
  en: [
    {
      ...
      description:
        "Experienced hospitality professionals deployed with structured hotel service manuals.",
      image: "/home/revenue-growth/image-1.webp",
    },
    {
      id: 2,
      title: "Training & Operational Manuals",
      description:
    ...
    },
    {
      ...
      description:
        "• Maximum OTA exposure\n• Multi-channel sales management\n• Aggressive SNS and digital campaigns",
      image: "/home/revenue-growth/image-3.webp",
    },
    {
      id: 4,
      title: "Strategic Operational Planning",
      description: "Ongoing analysis and revenue optimization led by professional managers.",
      image: "/home/revenue-growth/image-4.webp",
    },
  ],
} as const;
  ...
  return (
    <section className="w-full overflow-hidden bg-[#F5F5F5] py-16 md:py-20 lg:pt-21.5 lg:pb-42.25">
      <h2 className="mb-12 px-2.5 text-center font-chosunilbo font-normal text-[22px] text-logo-gradient md:mb-18 md:px-0 md:text-4xl lg:text-[43px]">
        {isEn ? "STAY-G Solutions" : "가치와 매출을 올리는 STAY-G 솔루션"}
      </h2>

      {isEn && (
        <p className="mb-10 px-2.5 text-center font-light text-[#474747] text-sm md:text-base">
          Driving Asset Value and Revenue Growth
        </p>
      )}
