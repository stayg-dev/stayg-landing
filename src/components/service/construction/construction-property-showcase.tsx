...
export default function ConstructionPropertyShowcase() {
  ...
  return (
    <section className="relative flex min-h-145 items-center overflow-hidden bg-black lg:min-h-225">
      {/* Background Image */}
      <Image
        src="/service/construction/construction-property-showcase/bg-image.webp"
                  ...
                  >
                    <div className="relative h-full w-full overflow-hidden">
                      ...
                      <div className="absolute inset-x-0 bottom-0 flex flex-col gap-1 p-4 sm:p-8 lg:p-10 xl:gap-4 xl:p-15">
                        {/* Tag Badge */}
                        <span className="w-fit rounded-full border border-white bg-black/45 px-1.5 py-1 text-[10px] text-white xl:px-2.5 xl:text-sm">
                          {property.tag}
                        </span>
